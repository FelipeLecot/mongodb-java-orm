...
import org.mongodb.client.event.ResultHandler;
...
public interface MongoTemplet {
   ...
   * @return int The number of rows affected by the update.
   */
  long update(String statement, Object parameter);
   ...
   * @return int The number of rows affected by the delete.
   */
  long delete(String statement, Object parameter);
   ...
   * @param statement Unique identifier matching the statement to execute.
   * @return Mapped objects affected by the command.
   * @deprecated Mongodb 3.4 deprecates the db.collection.group() method. Use db.collection.aggregate() with the $group stage or db.collection.mapReduce() instead.
   */
  ...
  /**
   * Execute a mapReduce statement.
   * @param <T> the returned object type.  
   * @param statement Unique identifier matching the statement to execute.
   * @return Mapped objects affected by the command.
   */
  <T> List<T> mapReduce(String statement);
  
  /**
   * Execute a mapReduce statement from the statement key and parameter.
   * @param <T> the returned object type.   
   * @param statement Unique identifier matching the statement to execute.
   * @param parameter A parameter object to pass to the statement.
   * @return Mapped objects affected by the command.
   */
  <T> List<T> mapReduce(String statement, Object parameter);
   ...
   * @param handler ResultHandler that will handle each retrieved row.
   */
  void mapReduce(String statement, ResultHandler handler);
   ...
   * @param handler ResultHandler that will handle each retrieved row.
   */
  void mapReduce(String statement, Object parameter, ResultHandler handler);
   ...
   */
  <T> T parseObject(String mappingId, Document source);
